...
public class DoiMatKhau extends javax.swing.JFrame {
    ...
    public NhanVien_DAO nv_dao = new NhanVien_DAO();
    public static JFrame main;

    public DoiMatKhau(NhanVien nv, JFrame main) {
        initComponents();
        this.nv = nv;
        this.main = main;
    ...
    private void btn_XacNhanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_XacNhanMouseClicked
        ...
        if(nv.getPass_word().equals(matKhauCu)) {
//            nv_dao.CapNhatTK(tk.getMaTK(), matKhauMoi);
...
//            this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoiMatKhau(nv, main).setVisible(true);
            }
        });
    }
