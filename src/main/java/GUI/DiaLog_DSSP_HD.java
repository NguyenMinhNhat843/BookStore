...
public class DiaLog_DSSP_HD extends javax.swing.JFrame {
    ...
    public void DocThongTinLenHD() {
        ...
        lbl_TienThoi1.setText(hd.getTien_thua() + "");
        lbl_TongThue1.setText(hd.getTong_thue()+ "");
        lbl_TongKM1.setText(hd.getTong_km() + "");
    }
    ...
    public void DocDuLieuHoaDon() {
        ...
        lbl_TongThue1.setText(hd.getTong_thue()+ "");
        lbl_TongKM1.setText(hd.getTong_km()+ "");
        lbl_ThanhTien1.setText(hd.getTong_tien()+ "");
        lbl_TienThoi1.setText(hd.getTien_thua() + "");
    }
    ...
    private void initComponents() {
        ...
        tbl_DSSP.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã SP", "Tên", "Loại", "Số lượng", "Thuế", "Khuyến Mãi", "Đơn giá", "Thành tiền"
            }
        ));
