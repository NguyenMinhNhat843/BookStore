...
public class Panel_Main extends javax.swing.JFrame {
    ...
    public Panel_Main(NhanVien nv) {
        connect();
        this.nv = nv == null 
                ? new NhanVien("NVTest", "NV_Test", "NV_Test", "Address_Test",
                        LocalDate.MIN, "Nam", "test@gmail.com", "test_user_name", 
                        "test_pass", "Quanr Lys", "0123456789")
                : nv;
        initComponents();
        xuLyDangNhap();
    ...
    public void xuLyDangNhap() {
        lbl_type_NV.setText(nv.getRole());
        lbl_name_NV.setText(nv.getLast_name());
        if(nv.getRole().compareTo("Nhân Viên") == 0) {
            disableFuntionForNVBH();
        } 
    }
    
    public void disableFuntionForNVBH() {
        Arrays.stream(new Component[]{btn_staff, btn_inventory, btn_anylist}).forEach(item -> item.setVisible(false));
    }
    ...
    private void initComponents() {
        ...
        lbl_logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/logo_image.png"))); // NOI18N
        ...
        btn_home.setPreferredSize(new java.awt.Dimension(250, 50));
...
//        String path = System.getProperty("user.dir") + "/HuongDanSuDung/HDSD.pdf";
        File file = new File(getClass().getResource("/HuongDanSuDung/HDSD.pdf").toString());
        try {
